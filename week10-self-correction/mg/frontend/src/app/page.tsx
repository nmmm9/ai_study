        ...
        <header className="flex items-center justify-between border-b border-stroke/30 px-6 py-3">
          <div>
            <h1 className="text-[15px] font-semibold tracking-tight text-pearl">
              K-Agent
              <span className="text-purple text-[11px] font-normal ml-1.5">Self-Correction Loop</span>
            </h1>
            <p className="text-[10px] text-pearl-muted/60">Supervisor → Domains → Writer ⇄ Critic (자가 검증/재작성)</p>
          </div>
        ...
        <div className="flex-1 overflow-y-auto">
          {messages.length === 0 ? (
            <div className="flex h-full flex-col items-center justify-center px-6">
              <p className="mb-1 text-[11px] uppercase tracking-[0.3em] text-pearl-muted/40">Self-Correction · Critic Loop</p>
              <h2 className="mb-3 font-serif text-4xl font-light tracking-tight text-pearl">K-Agent</h2>
              <p className="mb-2 text-sm text-pearl-muted">Writer가 답변을 작성하면 Critic이 1~10점으로 채점</p>
              <p className="mb-1 text-[11px] text-pearl-muted/50">7점 미만이면 Critic 피드백을 반영해 Writer가 자동 재작성</p>
              <p className="mb-10 text-[11px] text-pearl-muted/50">최대 2회 재작성 · 오른쪽 그래프에서 루프 흐름 시각화</p>
